        ...
        ssrRenderList($props.balisafari, (item, index) => {
          _push2(ssrRenderComponent(_component_swiper_slide, { key: index }, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              var _a, _b;
              if (_push3) {
                _push3(`<div class="hover-content relative"${_scopeId2}><div class="placetogo-port" data-cursor="pointer2" style="${ssrRenderStyle({ "height": "100%" })}"${_scopeId2}><img${ssrRenderAttr("src", (_a = item.images[0]) == null ? void 0 : _a.path)} class="filter brightness-50" alt="" style="${ssrRenderStyle({ "height": "15rem" })}"${_scopeId2}><div class="cover p-5"${_scopeId2}><div class="detail text-white"${_scopeId2}><h5 class="boldfont text-white text-xl mb-5"${_scopeId2}>${ssrInterpolate(item.name)}</h5><p class="content text-md line-clamp-3" style="${ssrRenderStyle({ "font-size": "12px" })}"${_scopeId2}>${(_a2 = item.highlight) != null ? _a2 : ""}</p></div></div><div class="z-20 absolute bottom-[5%] left-[5%]"${_scopeId2}>`);
...
//# sourceMappingURL=ExplorerSPData-D5u9ZAuR.mjs.map
