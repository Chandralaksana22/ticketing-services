...
import { b as useAsyncData, g as getVendors, c as getBaliZooPopular, d as getBaliBirdPopular, e as getBaliFarmPopular, f as getBaliSafariPopular, _ as _export_sfc, a as __nuxt_component_0 } from './server.mjs';
import { ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderAttrs } from 'vue/server-renderer';
import { ref, useSSRContext, unref, withCtx, createTextVNode, createVNode, toDisplayString, resolveComponent, openBlock, createBlock, Fragment, renderList, mergeProps, createCommentVNode } from 'vue';
...
const _imports_0$1 = "" + buildAssetsURL("maps.B9BR_n8w.jpeg");
const _imports_0 = "" + buildAssetsURL("image-13.Dl4S915i.png");
const _sfc_main$8 = {};
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="BaliBirdParkGA" role="tabpanel" aria-labelledby="BaliBirdParkGA-tab"><div class="overflow-y-auto h-[50vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 w-full"><!--[-->`);
      ssrRenderList(unref(balibird), (product) => {
        _push(`<div><a${ssrRenderAttr("href", product.link_address)}><img class="rounded-none h-[25vh] object-cover w-full object-top"${ssrRenderAttr("src", product.images[0].path)}${ssrRenderAttr("alt", product.name)}></a><div class="p-2 text-center"><h5 class="mb-2 text-md font-bold tracking-tight text-gray-900">${ssrInterpolate(product.name)}</h5>`);
        if (product.vendor) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/ticket-detail/${product.vendor.slug}/${product.slug}`,
      ...
      _push(`<!--]--></div></div><div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="BaliFarmHouseGA" role="tabpanel" aria-labelledby="BaliFarmHouseGA-tab"><div class="overflow-y-auto h-[50vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 w-full"><!--[-->`);
      ssrRenderList(unref(balifarm), (product) => {
        _push(`<div><a${ssrRenderAttr("href", product.link_address)}><img class="rounded-none h-[25vh] object-cover w-full object-top"${ssrRenderAttr("src", product.images[0].path)}${ssrRenderAttr("alt", product.name)}></a><div class="p-2 text-center"><h5 class="mb-2 text-md font-bold tracking-tight text-gray-900">${ssrInterpolate(product.name)}</h5>`);
        if (product.vendor) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/ticket-detail/${product.vendor.slug}/${product.slug}`,
      ...
      _push(`<!--]--></div></div><div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="BaliSafariGA" role="tabpanel" aria-labelledby="BaliSafariGA-tab"><div class="overflow-y-auto h-[50vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 w-full"><!--[-->`);
      ssrRenderList(unref(balisafari), (product) => {
        _push(`<div><a${ssrRenderAttr("href", product.link_address)}><img class="rounded-none h-[25vh] object-cover w-full object-top"${ssrRenderAttr("src", product.images[0].path)}${ssrRenderAttr("alt", product.name)}></a><div class="p-2 text-center"><h5 class="mb-2 text-md font-bold tracking-tight text-gray-900">${ssrInterpolate(product.name)}</h5>`);
        if (product.vendor) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/ticket-detail/${product.vendor.slug}/${product.slug}`,
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ref(null);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><button id="button-modal-opening" class="flex flex-col lg:flex-row items-center text-center lg:text-left clock" type="button" data-v-66c8b624><svg xmlns="http://www.w3.org/2000/svg" class="h-[48px] lg:h-[65px]" viewBox="0 0 64 65" fill="none" data-v-66c8b624><path d="M32 6.5C26.8577 6.5 21.8309 8.02487 17.5552 10.8818C13.2795 13.7387 9.94702 17.7994 7.97914 22.5502C6.01127 27.3011 5.49638 32.5288 6.49959 37.5723C7.50281 42.6159 9.97907 47.2486 13.6152 50.8848C17.2514 54.5209 21.8842 56.9972 26.9277 58.0004C31.9712 59.0036 37.1989 58.4887 41.9498 56.5209C46.7007 54.553 50.7613 51.2205 53.6182 46.9448C56.4751 42.6691 58 37.6423 58 32.5C57.9927 25.6066 55.2511 18.9976 50.3767 14.1233C45.5024 9.24889 38.8934 6.50728 32 6.5ZM46 34.5H32C31.4696 34.5 30.9609 34.2893 30.5858 33.9142C30.2107 33.5391 30 33.0304 30 32.5V18.5C30 17.9696 30.2107 17.4609 30.5858 17.0858C30.9609 16.7107 31.4696 16.5 32 16.5C32.5304 16.5 33.0392 16.7107 33.4142 17.0858C33.7893 17.4609 34 17.9696 34 18.5V30.5H46C46.5304 30.5 47.0392 30.7107 47.4142 31.0858C47.7893 31.4609 48 31.9696 48 32.5C48 33.0304 47.7893 33.5391 47.4142 33.9142C47.0392 34.2893 46.5304 34.5 46 34.5Z" fill="#BF9500" data-v-66c8b624></path></svg><div data-v-66c8b624><p class="font-bold text-sm lg:text-lg" data-v-66c8b624>Opening Hour</p><p class="text-sm hidden lg:block" data-v-66c8b624>Check all opening hour</p></div></button><div id="openinghour-modal" data-modal-backdrop="openinghour" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full" data-v-66c8b624><div class="relative p-4 w-full max-w-2xl max-h-full" data-v-66c8b624><div class="relative bg-white rounded-lg shadow dark:bg-gray-700" data-v-66c8b624><div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600" data-v-66c8b624><h3 class="text-xl text-center boldfont lg:text-start font-semibold text-blue" data-v-66c8b624> Opening Hour </h3><button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" id="closeButton-openinghour-modal" data-v-66c8b624><svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" data-v-66c8b624><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" data-v-66c8b624></path></svg><span class="sr-only" data-v-66c8b624>Close modal</span></button></div><div class="p-4 md:p-5 space-y-4" data-v-66c8b624><div class="mb-4" data-v-66c8b624><ul class="block lg:flex flex-wrap justify-center -mb-px text-sm font-medium text-center gap-4" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist" data-v-66c8b624><!--[-->`);
      ssrRenderList(__props.vendors, (vendor) => {
        _push(`<li data-v-66c8b624><button class="inline-block mb-2 w-full p-2 px-5 tab-button rounded-lg"${ssrRenderAttr("data-tabs-target", "#" + vendor.slug)} type="button" role="tab"${ssrRenderAttr("aria-controls", vendor.slug)}${ssrRenderAttr("aria-selected", false)} data-v-66c8b624>${ssrInterpolate(vendor.name)}</button></li>`);
      });
      _push(`<!--]--></ul></div><div id="default-tab-content" data-v-66c8b624><!--[-->`);
      ssrRenderList(__props.vendors, (vendor) => {
        _push(`<div${ssrRenderAttr("id", vendor.slug)} class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" role="tabpanel"${ssrRenderAttr("aria-labelledby", vendor.slug)} data-v-66c8b624><div data-v-66c8b624><!--[-->`);
        ssrRenderList(vendor.schedule, (schedule) => {
          _push(`<div class="grid grid-cols-2 gap-2 w-full lg:w-3/4" data-v-66c8b624><p class="font-bold" data-v-66c8b624>${ssrInterpolate(schedule.day)}</p><p data-v-66c8b624>${ssrInterpolate(schedule.start_time.slice(11, 16))} - ${ssrInterpolate(schedule.end_time.slice(11, 16))}</p></div>`);
        });
        _push(`<!--]--></div></div>`);
      });
...
const OpeningHourModal = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-66c8b624"]]);
const _sfc_main$4 = {
  components: {
    Swiper,
    SwiperSlide
        ...
        ssrRenderList($props.balisafari, (item, index) => {
          _push2(ssrRenderComponent(_component_swiper_slide, { key: index }, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              var _a;
              if (_push3) {
                _push3(`<div class="relative"${_scopeId2}><img${ssrRenderAttr("src", item.images.length > 0 ? item.images[0].path : "https://dashboard.bali-zoo.com/storage/photos/shares/Animals/Lion/Lion.jpg")}${ssrRenderAttr("alt", item.name)} class="h-[60vh] w-full object-cover filter brightness-50 rounded-[20px]"${_scopeId2}><div class="px-5 absolute bottom-[5%] text-white"${_scopeId2}><h1 class="boldfont text-yellow mb-3 text-xl"${_scopeId2}>${ssrInterpolate(item.name)}</h1><div class="mb-5 line-clamp-3"${_scopeId2}>${(_a = item.short_desc) != null ? _a : ""}</div>`);
                if (item.vendor) {
...
//# sourceMappingURL=index-CkTH3nm6.mjs.map
