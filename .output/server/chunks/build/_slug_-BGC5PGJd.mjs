...
import { b as useAsyncData, k as getProductBaliSafari, l as getProductBaliFarm, _ as _export_sfc, a as __nuxt_component_0$1 } from './server.mjs';
import { ref, unref, useSSRContext, withCtx, createTextVNode, mergeProps, createVNode, openBlock, createBlock, Fragment, renderList } from 'vue';
import { ssrRenderAttr, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
import { a as __nuxt_component_1, _ as __nuxt_component_2 } from './ExplorerSPData-D5u9ZAuR.mjs';
...
const _imports_0 = "" + buildAssetsURL("varunalogo.BqrHtd8Q.png");
const _imports_1 = "" + buildAssetsURL("background-biru-desktop.lyAKzMYD.png");
const _imports_2 = "" + buildAssetsURL("member1.DL8Fk1Ru.png");
const _imports_3 = "" + buildAssetsURL("member2.D5l2A_cX.png");
const _sfc_main$2 = {
  __name: "BaliFarmGA",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=_slug_-BGC5PGJd.mjs.map
