import { version, unref, inject, ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, defineComponent, provide, createElementBlock, h, shallowReactive, watch, Suspense, nextTick, Transition, hasInjectionContext, computed, resolveComponent, useSSRContext, createApp, effectScope, reactive, isRef, isReactive, toRaw, onErrorCaptured, createVNode, resolveDynamicComponent, getCurrentScope, onScopeDispose, defineAsyncComponent, mergeProps, isReadonly, toRefs, markRaw, isShallow, withAsyncContext, withCtx, createTextVNode, openBlock, createBlock } from 'vue';
import { $ as $fetch, l as defu, m as hasProtocol, n as joinURL, p as parseURL, o as parseQuery, q as createHooks, h as createError$1, w as withQuery, r as isScriptProtocol, t as withTrailingSlash, v as withoutTrailingSlash, x as sanitizeStatusCode, y as isSamePath, z as toRouteMatcher, A as createRouter$1, B as klona, C as parse, D as getRequestHeader, E as destr, F as isEqual, G as setCookie, H as getCookie, I as deleteCookie } from '../runtime.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderClass, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./contact-B_2ADoWl.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_productSlug_-52cms5QJ.mjs').then((m) => m.default || m)
  },
  {
    name: "ticket",
    path: "/ticket",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./ticket-BzC09V_t.mjs').then((m) => m.default || m)
  },
  {
    name: "vendor-slug",
    path: "/vendor/:slug()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_slug_-BGC5PGJd.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BZzXRN9d.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-3I9hwMKy.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_0 as a, useAsyncData as b, getBaliZooPopular as c, getBaliBirdPopular as d, entry$1 as default, getBaliFarmPopular as e, getBaliSafariPopular as f, getVendors as g, getProductDetail as h, injectHead as i, defineStore as j, getProductBaliSafari as k, getProductBaliFarm as l, resolveUnrefHeadInput as r, useRouter as u };
