import { _ as _export_sfc, a as __nuxt_component_0, b as useAsyncData, g as getVendors, k as getProductBaliSafari } from "../server.mjs";
import { resolveComponent, mergeProps, withCtx, createVNode, toDisplayString, createTextVNode, useSSRContext, openBlock, createBlock, Fragment, renderList, ref, withAsyncContext } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderStyle } from "vue/server-renderer";
import { _ as __nuxt_component_2, a as __nuxt_component_1 } from "./ExplorerSPData-D5u9ZAuR.js";
...
import "axios";
import "flowbite";
const _imports_0 = "" + __buildAssetsURL("heroticket.CYqgVe8K.png");
const _imports_1 = "" + __buildAssetsURL("logomob.CrD18KKz.png");
const _sfc_main$2 = {
  name: "TicketCard",
  props: {
    imageSrc: {
              ...
              if (_push3) {
                _push3(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    var _a, _b;
                    if (_push4) {
                      _push4(`<div class="bg-white h-full overflow-hidden rounded-lg card-zoom-hover"${_scopeId3}><div class="overflow-hidden"${_scopeId3}><img${ssrRenderAttr("src", (_a = item.images[0]) == null ? void 0 : _a.path)} class="rounded-t-lg h-[35vh] w-full object-cover" alt="image"${_scopeId3}></div><div class="p-5"${_scopeId3}><h4 class="boldfont text-center text-lg text-blue"${_scopeId3}>${ssrInterpolate(item.name)}</h4><p class="text-sm text-center" style="${ssrRenderStyle({ "font-size": "12px" })}"${_scopeId3}>${item.highlight ?? ""}</p></div></div>`);
                    } else {
                      return [
...
//# sourceMappingURL=ticket-BzC09V_t.js.map
